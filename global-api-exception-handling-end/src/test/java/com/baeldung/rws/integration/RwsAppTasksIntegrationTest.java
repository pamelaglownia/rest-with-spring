...
public class RwsAppTasksIntegrationTest {
    ...
    void givenPreloadedData_whenUpdateExistingTaskPointingToNonExistingProject_thenServerError() {
        TaskDto updatedTaskBody = new TaskDto(null, "changed-uuid", "Test - Task To Non Existing Project", "Description of task", LocalDate.of(2030, 06, 01), TaskStatus.DONE, 99L, null);
