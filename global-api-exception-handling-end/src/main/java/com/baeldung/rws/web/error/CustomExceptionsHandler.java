...
public class CustomExceptionsHandler {
    ...
    // return new CustomErrorBody("Invalid associated entity: " + ex.getMessage(), "INVALID_PROJECT_ID");
    // }
    ...
    // .body(new CustomErrorBody("Invalid associated entity: " + ex.getMessage(), "INVALID_PROJECT_ID"));
    // }
