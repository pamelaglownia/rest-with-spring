...
public class RwsAppProjectsIntegrationTest {
    ...
    void givenPreloadedData_whenUpdateExistingProjectUsingExistingTask_thenTaskNotSwitchedToProject() {
        ...
        TaskDto newTaskBody = new TaskDto(null, null, "Test - Project Task X", "Description of Project task", LocalDate.of(2030, 01, 01), null, 1L, null);
    ...
    @Test
    void whenMockedDeleteProject_thenReturnsNoContent() {
        webClient.delete()
            .uri("/projects/99")
            .exchange()
            .expectStatus()
