...
public class RwsAppTasksIntegrationTest {
    ...
    @Test
    void whenCreateNewTask_thenCreatedWithoutModifyingAssociatedProjectAndToDoStatus() {
    ...
    void whenCreateNewTaskWithInvalidScenarios_thenBadRequest() {
        ...
        // null projectId
        TaskDto nullProjectIdTaskBody = new TaskDto(null, null, "A Name", "Description of task", LocalDate.of(2030, 01, 01), TaskStatus.DONE, null, null, null);
        //
        webClient.post()
            .uri("/tasks")
            .body(Mono.just(nullProjectIdTaskBody), TaskDto.class)
            .exchange()
            .expectStatus()
            .isBadRequest()
            .expectBody()
            .jsonPath("$.errors..field")
            .value(hasItem("projectId"));
    ...
    @Test
    void givenPreloadedData_whenUpdateExistingTaskPointingToNonExistingProject_thenServerError() {
        TaskDto updatedTaskBody = new TaskDto(null, "changed-uuid", "Test - Task To Non Existing Project", "Description of task", LocalDate.of(2030, 06, 01), TaskStatus.DONE, 99L, null, 10);
        ...
        webClient.get()
            ...
            .expectBody()
            .jsonPath("$.name")
            .value(not("Test - Task To Non Existing Project"));
    }
    ...
    void whenUpdateWithInvalidScenarios_thenBadRequest() {
        ...
        // null projectId
        TaskDto nullProjectIdTaskBody = new TaskDto(null, "any-uuid", "Test - Task X", "Description of task", LocalDate.of(2030, 06, 01), TaskStatus.DONE, null, null, null);
